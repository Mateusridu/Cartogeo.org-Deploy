  ...
  return (
    ...
    >
      <div className="container-page flex h-16 items-center justify-between">
        ...
        >
          <img
            src={`${import.meta.env.BASE_URL.replace(/\/$/, "")}/${solid ? "logo-cartogeo-icon-black.svg" : "logo-cartogeo-icon-white.svg"}`}
            alt="CartoGeo"
        ...
        >
          Fale conosco
          <svg viewBox="0 0 16 16" className="h-5 w-4" fill="none" aria-hidden="true">
